export function LabVRLogo({ size = 36, showText = true, textColor = "#026584" }) {
  return (
    <div className="labvr-brand-container" style={{ display: "inline-flex", alignItems: "center", gap: "10px" }}>
      ...
      >
        <g fill="#026584">
          ...
          <path d="M30 78C64 90 88 118 84 144C76 120 52 101 29 91C29.2 86.6 29.5 82.2 30 78Z" />
      ...
      {showText && (
        ...
        >
          Lab<span style={{ fontWeight: 800, color: "#007ea7" }}>VR</span>
        </span>
      )}
    </div>
  );
